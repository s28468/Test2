    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AstronautMissions", x => new { x.AstronautId, x.MissionId });
                    table.ForeignKey(
                        name: "FK_AstronautMissions_Astronauts_AstronautId",
                        column: x => x.AstronautId,
                        principalTable: "Astronauts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AstronautMissions_Missions_MissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AstronautMissions_MissionId",
                table: "AstronautMissions",
                column: "MissionId");
